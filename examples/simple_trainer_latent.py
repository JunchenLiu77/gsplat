...
"""
CUDA_VISIBLE_DEVICES=9 python simple_trainer_nocons.py --data_dir ~/dataset/360_v2/garden --data_factor 8 --max_steps 7000 \
  --strategy.refine_stop_iter -1 \
  --port 8091 \
  --result_dir results/debug_12500t8_onlychamfer
"""
